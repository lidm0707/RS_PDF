use crate::backend::{
    ...
    repo::db_payment::db_select::{select_payment_type, select_payment_type_where},
};
...
pub fn sv_get_payment_type() -> Result<Vec<ModelPaymentType>, anyhow::Error> {
    // Safely call `select_payment_type_where` and propagate errors
    let raw = select_payment_type()?;
