...
pub fn sv_get_installment() -> Result<Vec<ModelInstallment>, anyhow::Error> {
...
pub fn sv_get_installment_items() -> Result<Vec<ModelInstallmentItems>, anyhow::Error> {
...
pub fn sv_get_installment_items_where(
    input_id: i32,
